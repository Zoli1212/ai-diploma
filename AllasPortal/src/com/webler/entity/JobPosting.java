...
public class JobPosting {
	...
	public String toString() {
		return "JobPosting [id=" + id + ", messageBody=" + messageBody + ", jobName=" + jobName + ", posterName="
				+ posterName + ", contactPhone=" + contactPhone + ", jobPostingPassword=" + jobPostingPassword + "]";
	}
