package com.sirius.jobportal.entity;
...
public class JobPosting {
	...
	public String toString() {
		return "JobPosting [messageBody=" + messageBody + ", jobName=" + jobName + ", posterName=" + posterName
				+ ", contactPhone=" + contactPhone + ", jobPostingPassword=" + jobPostingPassword + "]";
	}
